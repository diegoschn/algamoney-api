...
CREATE TABLE permissao (
	...
	CONSTRAINT permissao_id_pk PRIMARY KEY (id)
);
...
alter table usuario_permissao
     add constraint FK_USUARIO_PERMISSAO_REFERENCE_USUARIO foreign key (id_usuario)
        references usuario (id)
        on delete restrict on update restrict;

  alter table usuario_permissao
       add constraint FK_USUARIO_PERMISSAO_REFERENCE_PERMISSAO foreign key (id_permissao)
